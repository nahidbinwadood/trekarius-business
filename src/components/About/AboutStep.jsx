function AboutStep({ text, img, shapeColor, isReversed }) {
  return (
    <div className={`flex max-md:flex-col items-center gap-[134px] max-md:gap-10 custom-xs:!gap-8 justify-center mt-[30px] max-md:mt-0 ${isReversed ? 'flex-row-reverse' : ''}`}>
      ...
      <div className="max-w-[650px] max-md:order-1 h-[520px] custom-sm:h-[335px] custom-xs:h-[300px] p-3 custom-xs:p-0 about-step-img relative z-[1] mt-[30px] max-md:mt-0" data-aos={isReversed ? 'fade-right' : 'fade-left'}>
        <img className="h-full w-full rounded-[20px]" src={img} alt="img" />
        <div
